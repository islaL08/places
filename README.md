...
- **Prompt Book**: all 38 of Shakespeare's plays with study notes, character profiles and plain-English help; over a thousand monologues; the 154 sonnets; a directory of screen monologues; your own scripts and highlights.
...
- **Shakespeare's plays:** [Folger Digital Texts](https://www.folger.edu/explore/shakespeares-works/), Folger Shakespeare Library, used under [CC BY-NC 3.0](https://creativecommons.org/licenses/by-nc/3.0/). Changes: the texts are split into scenes and speeches for this app; the wording is unchanged. The plain-English versions, study notes and character notes are new work written for Places. Non-commercial use only.
